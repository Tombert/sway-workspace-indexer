...
use std::{collections::HashMap,collections::HashSet, error::Error, future::Future, pin::Pin};
...
async fn do_new_workspace() -> StdResult<(),  Box<dyn Error>> {
